...
<body>
	...
	<form:form action="${addAction}" commandName="student">
		<table>
			...
			<tr>
				<td><form:label path="observations">
						<spring:message text="Observations" />
					</form:label></td>
				<td><form:input path="observations" /></td>
			</tr>
			<tr>
				<td><form:label path="projectEvaluation">
						<spring:message text="Project Evaluation" />
					</form:label></td>
				<td><form:input path="projectEvaluation" /></td>
			</tr>
			<tr>
	...
	<c:if test="${!empty listStudents}">
		<table class="tg">
			<tr>
				...
				<th width="80">Project Evaluation</th>
				<th width="60">Edit</th>
			...
			<c:forEach items="${listStudents}" var="student">
				<tr>
					...
					<td>${student.projectEvaluation}</td>
